...
export async function loader() {
    ...
    await Promise.all([
        fetch(`${process.env.REACT_APP_API_URL}/admin/summary/sales?days=7`)
        .then(response => response.json())
        .then(data => sales = data)
        .catch(error => console.log(error)),

        fetch(`${process.env.REACT_APP_API_URL}/admin/summary/orders?Status=1`)
            .then(response => response.json())
            .then(data => carts = data)
            .catch(error => console.log(error)),
        
        fetch(`${process.env.REACT_APP_API_URL}/admin/summary/orders?Status=2`)
            .then(response => response.json())
            .then(data => processing = data)
            .catch(error => console.log(error)),
        
        fetch(`${process.env.REACT_APP_API_URL}/admin/summary/orders?Status=3`)
            .then(response => response.json())
            .then(data => shipped = data)
            .catch(error => console.log(error)),
        
        fetch(`${process.env.REACT_APP_API_URL}/admin/summary/orders?Status=4&Days=7`)
            .then(response => response.json())
            .then(data => delivered = data)
            .catch(error => console.log(error)),
        
        fetch(`${process.env.REACT_APP_API_URL}/admin/summary/orders?Status=5&Days=7`)
            .then(response => response.json())
            .then(data => returns = data)
            .catch(error => console.log(error)),

        fetch(`${process.env.REACT_APP_API_URL}/admin/summary/inventory?Threshold=10`)
            .then(response => response.json())
