...
namespace CommerceReactDemo.Data
{
    public class ApplicationDbContext : ApiAuthorizationDbContext<ApplicationUser>
    {
        ...
        public DbSet<CommerceReactDemo.Models.Product> Product { get; set; } = default!;
        public DbSet<CommerceReactDemo.Models.ProductCategory> ProductCategory { get; set; } = default!;
        public DbSet<CommerceReactDemo.Models.StateLocation> StateLocation { get; set; } = default!;
        public DbSet<CommerceReactDemo.Models.Order> Order { get; set; } = default!;
        public DbSet<CommerceReactDemo.Models.OrderProduct> OrderProduct { get; set; } = default!;
        public DbSet<CommerceReactDemo.Models.OrderStatus> OrderStatus { get; set; } = default!;
        public DbSet<CommerceReactDemo.Models.OrderHistory> OrderHistory { get; set; } = default!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CommerceReactDemo.Models.OrderStatus>().ToTable("OrderStatus");
